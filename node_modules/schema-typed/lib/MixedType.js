        ...
        if (nestedObject) {
            ...
            if (arrayMatch) {
                ...
                if (type === null || type === void 0 ? void 0 : type[exports.arrayTypeSchemaSpec]) {
                    const arrayType = type[exports.arrayTypeSchemaSpec];
                    if (namePath.length > 1) {
                        if (arrayType[exports.schemaSpecKey]) {
                            return getFieldType(arrayType[exports.schemaSpecKey], namePath.slice(1).join('.'), true);
                        }
                        if (Array.isArray(arrayType) && arrayType[parseInt(arrayIndex)][exports.schemaSpecKey]) {
                            return getFieldType(arrayType[parseInt(arrayIndex)][exports.schemaSpecKey], namePath.slice(1).join('.'), true);
                        }
                    }
                ...
                if (namePath.length > 1 && type && type[exports.schemaSpecKey]) {
                    return getFieldType(type[exports.schemaSpecKey], namePath.slice(1).join('.'), true);
                }
            }
        }
